...
@interface ZEExpertChatListVC ()<JMessageDelegate>
{
...
@implementation ZEExpertChatListVC
...
-(void)initView
{
    _chatTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, NAV_HEIGHT, SCREEN_WIDTH, SCREEN_HEIGHT - NAV_HEIGHT) style:UITableViewStylePlain];
