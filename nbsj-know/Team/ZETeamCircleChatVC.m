...
@interface ZETeamCircleChatVC ()<ZEChatViewDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
{
    ZEChatView * _chatView;
}
@end

@implementation ZETeamCircleChatVC
...
-(void)sendAnswerModelRequest
{
    ...
    [ZEUserServer getDataWithJsonDic:packageDic
                       showAlertView:NO
                             success:^(id data) {
                                 NSArray * arr = [ZEUtil getServerData:data withTabelName:V_KLB_TEAMCIRCLE_ANSWER_INFO];
                                 if (arr.count > 0) {
...
-(void)sendSearchAnswerRequestWithoutOPERATETYPE
{
    ...
    NSDictionary * parametersDic = @{@"limit":@"-1",
                                     @"MASTERTABLE":KLB_TEAMCIRCLE_QUE_ANS_DETAIL,
                                     @"MENUAPP":@"EMARK_APP",
    ...
    NSDictionary * packageDic = [ZEPackageServerData getCommonServerDataWithTableName:@[KLB_TEAMCIRCLE_QUE_ANS_DETAIL]
                                                                           withFields:@[fieldsDic]
                                                                       withPARAMETERS:parametersDic
                                                                       withActionFlag:nil];
    [ZEUserServer getDataWithJsonDic:packageDic
                       showAlertView:NO
                             success:^(id data) {
                                 NSArray *  _datasArr = [ZEUtil getServerData:data withTabelName:KLB_TEAMCIRCLE_QUE_ANS_DETAIL];
                              ...
                              withAnswerInfo:(ZEAnswerInfoModel *)answerModel
{
    NSDictionary * parametersDic = @{@"limit":@"20",
                                     ...
                                     @"DETAILTABLE":KLB_TEAMCIRCLE_QUESTION_INFO,
                                     ...
                                     @"CLASSNAME":@"com.nci.klb.app.teamcircle.AnswerTake",
                                     };
...
//                                 @"BONUSPOINTS":[NSString stringWithFormat:@"%@",_questionInfo.BONUSPOINTS]};
    NSDictionary * packageDic = [ZEPackageServerData getCommonServerDataWithTableName:@[KLB_TEAMCIRCLE_ANSWER_INFO,KLB_TEAMCIRCLE_QUESTION_INFO]
